...
<div style="display:flex; flex-wrap:wrap; gap:3rem; margin:2rem 0; align-items:flex-start;">
  ...
  <div style="flex:1; min-width:300px;">
    ...
    <p>
      Robotics MS student and former Zipline Intern focused on autonomy and   
      sensing. 
    </p>
    <p>
      A few highlights from my student research and courses that I can share publicly   
    </p>
    <p>
...
## Optical Flow based Velocity Estimation for Aerial Robots
 Graduate research at the Autonomous Systems Lab on high frequency kalman filtering using computer vision
<div class="feature__wrapper">
<!-- CARD 1: Tactile Sensing -->
<div class="feature__item" style="display:flex; flex-direction:column;">
  <h3 class="feature__title">Kalman Filtering</h3>

    <img src="{{ '/assets/images/flow_residuals_vs_time.jpg' | relative_url }}"
         style="grid-row: 1 / span 2; width:100%; border-radius:8px; object-fit:cover;">

  <p style="margin-top:auto;">
    Integrated monocular vision and imu measusrements in an unscented kalman filter for low-level ego motion estimation. (Data shown in plot is simulated for demonstration purposes).
  </p>
</div>

<!-- CARD 2: IMU Fall Recovery -->
<div class="feature__item" style="display:flex; flex-direction:column;">
  <h3 class="feature__title">3D Homography</h3>

  <div style="flex:0 0 auto;">
    <video controls style="width:100%; display:block; margin:0.5rem auto;">
      <source src="{{ '/assets/videos/rotation_transation_external_view.mov' | relative_url }}" type="video/mp4">
    </video>
  </div>

  <p style="margin-top:auto;">
   Camera linear and angular velocity constraints are based on 3D homography. Ground truth measurements are reconstructed from global bundal adjustement using reprojective geometry. 
  </p>
</div>

<!-- CARD 3: Simulation & Design -->
<div class="feature__item" style="display:flex; flex-direction:column;">
  <h3 class="feature__title">Dense Optical Flow</h3>

  <div style="flex:0 0 auto;">
    <video controls style="width:100%; display:block; margin:0.5rem auto;">
      <source src="{{ '/assets/videos/flow_video_trimmed.mp4' | relative_url }}" type="video/mp4">
    </video>
  </div>

  <p style="margin-top:auto;">
  Used classical-feature detector based flow such as Shi-Thomasi as well as dense, deep-learning based flow networks such as RAFT to obtain flow vectors.
  </p>
</div>
</div>
